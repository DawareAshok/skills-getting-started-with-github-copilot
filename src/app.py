...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 18,
        "participants": ["olivia@mergington.edu", "nathan@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Society": {
        "description": "Perform in plays, practice acting, and produce theater shows",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["eli@mergington.edu", "zara@mergington.edu"]
    },
    "Science Club": {
